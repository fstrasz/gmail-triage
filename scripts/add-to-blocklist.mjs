...
const toAdd = [
  {
    email: "customerservice@wienscellars.com",
    name: "Wiens Cellars",
    date: now,
    reason: "marketing",
  },
  {
    email: "wines@tamberbey.com",
    name: "Tamber Bey Vineyards",
    date: now,
    reason: "marketing",
  },
  {
    email: "hello@em.rivian.com",
    name: "Rivian",
    date: now,
    reason: "marketing",
  },
  ...
  {
    email: "southwestairlines@iluv.southwest.com",
    name: "Southwest Airlines",
    date: now,
    reason: "marketing",
  },
  {
    email: "eric.m.schiffer@interdependenchub.info",
    name: "Eric Schiffer",
    date: now,
    reason: "spam",
  },
  {
    email: "info@kirbys.fbmta.com",
    name: "Kirby's Steakhouse",
    date: now,
    reason: "marketing",
  },
  {
    email: "info@bookbub.com",
    name: "BookBub",
    date: now,
    reason: "marketing",
  },
  {
    email: "fl@e.myfilingservices.com",
    name: "FL Filing Services",
    date: now,
    reason: "spam",
  },
];
